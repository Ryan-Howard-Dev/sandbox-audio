...
const THEME_TONE_LABEL_KEYS: Record<string, string> = {
  ...
  Terminal: 'settings.architect.presets.terminal',
  'Deep Ocean': 'settings.architect.presets.deepOcean',
  'Blood Orange': 'settings.architect.presets.bloodOrange',
  Ember: 'settings.architect.presets.ember',
  Graphite: 'settings.architect.presets.graphite',
  Slate: 'settings.architect.presets.slate',
  Sepia: 'settings.architect.presets.sepia',
